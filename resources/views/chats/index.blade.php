...
<div class="flex flex-col h-screen w-screen bg-white">
  ...
  <div class="flex flex-row  items-center  bottom-0 my-2 w-full">
    ...
    <input type="text" id="nikname" 
    placeholder="votre pseudonyme"class="border rounded-2xl border-transparent w-full focus:outline-none text-sm h-10 flex items-center">
